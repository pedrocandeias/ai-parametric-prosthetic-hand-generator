...
// Paraglider Reborn palm spans REF_PALM_BREADTH mm at scale 1.0. Use the same value across the
...
// Palm breadth (mm) of the unscaled (scale 1.0) Paraglider Reborn palm.
REF_PALM_BREADTH = 80.6;
// derived hand scale, clamped to the printable 1.0-2.0x range
overall_scale = scale_override > 0 ? scale_override : max(1.0, min(2.0, palm_breadth_mm / REF_PALM_BREADTH));
